...
I did this by plotting the ranking of the airlines with the largest maximum early departure on the x-axis (ranking of 1 being the largest early departure) and the maximum delay value on the y-axis. Each point represents an indiviudal airline that you can see by hoving over the data point.
...
The pearson correlation coefficient value reveals there is virtually no correlation at all between maximum early departure ranking and maximum flight delay. This could be potentially very important information for travelers when booking since we can't confidently say that an airline with the lowest maximum delay also has the highest maximum early departure (and therefore shouldn't be a deciding factor when choosing an airline).
