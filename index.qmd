...
geom_point(shape = 18) +
theme_minimal()+
labs(x = "Maximum Early Departure (Min) Ranking", y = "Maximum Flight Delay (Min)", color = "Airline", title = "Airline Maximum Delay vs Early Departure") + 
...
It looks like ExpressJet Airlines and Asheville Regional Airport have the highest delay per airline/airport combination.
